...
```
yay -S awesome rofi picom i3lock-fancy-git xclip ttf-roboto polkit-gnome materia-gtk-theme lxappearance flameshot pnmixer network-manager-applet xfce4-power-manager -y
wget -qO- https://git.io/papirus-icon-theme-install | sh
```
...
```
git clone https://github.com/czM1K3/material-awesome.git ~/.config/awesome
```
